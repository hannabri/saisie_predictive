...
def aide_en_ligne():
    help_description = ("Le but du programme est de vous proposer une liste des mots probables pour constituer la suite d'un message. \n" +
                        ...
                        "De plus, notre programme ne peut malheureusement pas encore lire dans vos pensées. Il fait de son mieux pour vous proposer des mots basés sur la fréquence d'utilisation. Mais parfois il est possible que le mot que vous cherchez ne figure pas parmi les propositions. " +
